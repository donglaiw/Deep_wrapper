...
# 1. Data
myLoadData = LoadData('/home/Stephen/Desktop/Bird/DLearn/Data/Emotion/')
preprocess = 0
datasz = [125,100]
datasets = myLoadData.loadTrain(preprocessFLAG=preprocess,flipFLAG=3,cutFLAG=datasz[0])
train_set_x, train_set_y = datasets[0]
valid_set_x, valid_set_y = datasets[1]

dataset_test = myLoadData.loadTest(preprocess,cutFLAG=datasz[1])
test_set_x = dataset_test[0]
test_set_y = dataset_test[1]
ishape = Conv2DSpace(
        shape = [48, 48],
        num_channels = 1
        )
